% -------------------------------------------------------------------
%  Aquí se encuentra en forma de matríz la tabla A-17
...
%   1   T [K] = Temperatura
%   2   h [kJ/kg] = Entalpía
%   3   Pr [Adimensional] = Presión relativa
%   4   u [kJ/kg] = Energía interna
%   5   Vr [Adimensional] = Volumen especifico relativo
%   6   S [kJ/kg*K] = Entropía
%
% -------------------------------------------------------------------
 
function datos = A17(x,ColumnaX,ColumnaY)
%Regresa los valores de x0,x1,y0,y1 para la interpolación
...
TA17 = ...
  [200 199.97 0.3363 142.56 1707 1.29559;
   ...
   280 280.13 1.0889 199.75 738 1.63279;
   ...
   320 320.29 1.7375 228.42 528.6 1.7669;
   ...
   1000 1046.04 114 758.94 25.17 2.9677;
...
%Esta función busca en la tabla TA17 la ubicación de x:
...
switch ColumnaX
    case 1
        for i=1:121
            T = TA17(i,1);
            if T>x
                x0 = TA17(i-1,ColumnaX);
                x1 = TA17(i,ColumnaX);
                y0 = TA17(i-1,ColumnaY);
                y1 = TA17(i,ColumnaY);
                break;
            end
        end
